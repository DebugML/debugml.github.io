...
While white-box programs can be easier to learn with, they lack the expressiveness of black-box programs. 
Logic-program-based programs are incompatible with Python programs (*neuroPython*) and programs that call GPT (*neuroGPT*), 
...
the expected output is computed as:
