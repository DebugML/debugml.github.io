...
<!-- For CaptainCookRecipes, ARES is only slightly better than Entail-Prev. -->
<!-- This is potentially because the recipe graphs has fewer propagated errors comparing to linear chains in ClaimTrees, and it is harder to achieve  -->
